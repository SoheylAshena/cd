...
const Sider = ({ openSider }) => {
  const terms = {
    ...
    "(Shipping & Logistics ) حمل‌ونقل و لجستیک": [
      ...
      { en: "Freight", fa: "حمل بار غیر سریع / کرایه بار" },
    ...
    "(Miscellaneous ) متفرقه": [
      ...
      { en: "WTO (World Trade Organization)", fa: "سازمان تجارت جهانی" },
      { en: "WCO (World Customs Organization)", fa: "سازمان گمرک جهانی" },
      {
      ...
      { en: "NVOCC", fa: "شرکت حمل و نقل بدون مالکیت کشتی" },
      {
